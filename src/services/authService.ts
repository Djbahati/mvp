...
// Helper to simulate fallback user when backend API is not available
    ...
    try {
      ...
      return {
        ...
        data: {
          ...
          redirect_uri: typeof window !== 'undefined' ? `${window.location.origin}/api/auth/callback` : '/api/auth/callback'
        }
      };
    }
  },
