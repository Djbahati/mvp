  ...
  return (
    <div className="w-full max-w-md mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl text-center">
      ...
      {debugCodes.phoneCode ? (
        <div className="mb-5 p-3 rounded-xl bg-emerald-950/40 border border-emerald-800/60 text-emerald-200 text-xs flex items-center justify-between gap-2">
          <div>
          ...
          <button
            type="button"
            onClick={() => setCode(debugCodes.phoneCode || '654321')}
            className="px-2.5 py-1 bg-emerald-500 text-slate-950 font-bold rounded-lg text-[11px] hover:bg-emerald-400 transition-colors cursor-pointer"
          >
            Auto-Fill
          </button>
        </div>
        ...
        <div className="mb-5 p-3 rounded-xl bg-emerald-950/40 border border-emerald-800/60 text-emerald-200 text-xs flex items-center justify-between gap-2">
          <div>
            <span className="font-semibold">Sandbox Test OTP:</span> <code className="bg-slate-950 px-2 py-0.5 rounded font-mono font-bold">654321</code>
          </div>
          <button
            type="button"
            onClick={() => setCode('654321')}
            className="px-2.5 py-1 bg-emerald-500 text-slate-950 font-bold rounded-lg text-[11px] hover:bg-emerald-400 transition-colors cursor-pointer"
          >
            Auto-Fill
          </button>
